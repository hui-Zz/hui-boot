...
import com.hui.project.model.vo.RolePageVo;
...
public class RoleController extends BaseController {
    ...
    @GetMapping("/list")
    public Result page(RolePageVo vo) {
        startPage();
        startOrderBy();
    ...
    @PostMapping("/add")
    public Result add(@RequestBody @Validated CreateRoleInput input) {
    ...
    @PostMapping("/edit")
    public Result edit(@RequestBody @Validated(UpdateRoleInput.Update.class) UpdateRoleInput input) {
        Role role = input.convert(Role.class);
