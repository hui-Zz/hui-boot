package com.project.common.generate;
...
public class SuperGenerator {
	...
	protected StrategyConfig getStrategyConfig(String tableName) {
		...
		return new StrategyConfig()
				...
				//自定义实体父类
				.setSuperEntityClass("com.project.common.base.BaseModel")
				// 自定义实体，公共字段
				.setSuperEntityColumns("id","create_time","update_time")
				.setTableFillList(tableFillList)
				// 自定义 mapper 父类
				//.setSuperMapperClass("com.project.common.base.BaseMapper")
				// 自定义 controller 父类
				.setSuperControllerClass("com.project.common.base.CrudController")
				// 自定义 service 实现类父类
				.setSuperServiceImplClass("com.project.common.base.BaseServiceImpl")
				// 自定义 service 接口父类
				.setSuperServiceClass("com.project.common.base.BaseService")
